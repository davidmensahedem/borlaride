...
const LeftSideBar = () => {
    ...
    return (<div className="w-64 bg-white p-4 overflow-y-auto">
        <div className="mb-4">
            ...
            <div className="mb-3">
                ...
                <div className="flex space-x-2">
                    {[1, 2, 3, 4, '5+'].map((num, index) => (
                        <button
                            key={index}
                            className={`w-10 h-10 rounded flex items-center justify-center ${bedrooms === num ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-800'
                                }`}
            ...
            <div>
                ...
                <div className="flex space-x-2">
                    {[1, 2, 3, 4, '5+'].map((num, index) => (
                        <button
                            key={index}
                            className={`w-10 h-10 rounded flex items-center justify-center ${bathrooms === num ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-800'
                                }`}
